...
<body>
    ...
    <div id="slider">
        ...
        <span class="mx-10 font-bold text-blue-500 hidden">  1 ETHEREUM (ETH)  = 0.02776 BTC = $1185.89000000 USD +  0.25% </span>
        <span class="mx-10 font-bold text-blue-500 hidden">  1 BITCOIN (BTC)  = $20504.84000000 USD - 0.15% </span>
        <span class="mx-10 font-bold text-blue-500 hidden">  1 Valyou X Dollar (VXD) =    $1.00090000 USDC - 0.1% </span>
        <span class="mx-10 font-bold hidden">  1 VALYOU X MUSIC (VALYOU X) =   $0.50 USDC + 2.5% </span>
    </div>
    <div class="grid grid-cols-2 mt-20 px-20 gap-10">
        <div class="flex flex-col gap-5">
            <div class="blockchain_bck">
                <h2 class="text-sm font-black py-1 text-blue-400 bg-gray-100 text-center blockchain_text">
                    The World's First Blockchain Powered
                </h2>
            </div>
            <h1 class="text-5xl font-bold musicartist_text">
                Music Artist <span class="text-gradient-orange">Financial Stock</span> Market
            </h1>
        ...
        <img src="https://valyou-x.vercel.app/_next/image?url=%2Fassets%2Fvalyoux_img.jpeg&w=828&q=75" class="computer_img" />
    </div>
