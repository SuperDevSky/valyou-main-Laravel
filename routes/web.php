...
Route::get('/market', function () {
    $artists = [
        new Artist("Drake", "http://localhost:5000/img/drake.png", "rapper", "+250.9020", "1.4100", "141,000,000"),
        new Artist("Billy Bob", "http://localhost:5000/img/drake.png", "singer", "+149.9020", "1.4100", "141,000,000"),
        new Artist("Drake", "http://localhost:5000/img/drake.png", "rapper", "+249.9020", "1.4100", "141,000,000"),
        new Artist("Drake", "http://localhost:5000/img/drake.png", "rapper", "+249.9020", "1.4100", "141,000,000"),
        new Artist("Drake", "http://localhost:5000/img/drake.png", "rapper", "+249.9020", "1.4100", "141,000,000")
    ];
